...
Revision ID: 41158226e340
Revises: 
Create Date: 2019-06-24 15:15:56.052573
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['course_key'], ['course_repository.key'], name=op.f('fk_manage_course_perm_course_key_course_repository')),
    sa.ForeignKeyConstraint(['group_id'], ['group.id'], name=op.f('fk_manage_course_perm_group_id_group')),
    sa.PrimaryKeyConstraint('course_key', 'group_id', name=op.f('pk_manage_course_perm'))
    )
