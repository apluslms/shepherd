...
Revision ID: 90fe95b92cd5
Revises: 
Create Date: 2019-08-20 15:16:02.579115
...
def upgrade():
    ...
    sa.Column('result', sa.Enum('NONE', 'PUBLISH', 'RUNNING', 'SUCCESS', 'FAILED', 'CANCELED', name='buildstate'), nullable=True),
