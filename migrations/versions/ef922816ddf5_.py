...
Revision ID: ef922816ddf5
Revises: 
Create Date: 2019-08-02 15:17:20.812585
...
def upgrade():
    ...
    sa.Column('course__instance_id', sa.Integer(), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('admin', 'assistant', name='courseownertype'), nullable=True),
    sa.ForeignKeyConstraint(['course__instance_id'], ['course_instance.id'], name=op.f('fk_manage_course_perm_course__instance_id_course_instance')),
    sa.ForeignKeyConstraint(['group_id'], ['group.id'], name=op.f('fk_manage_course_perm_group_id_group')),
    sa.PrimaryKeyConstraint('course__instance_id', 'group_id', name=op.f('pk_manage_course_perm'))
    )
