...
Revision ID: 44b91eeb7977
Revises: 
Create Date: 2019-06-03 01:44:48.962696
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['group.id'], name=op.f('fk_course_repository_owner_id_group'), ondelete='CASCADE'),
